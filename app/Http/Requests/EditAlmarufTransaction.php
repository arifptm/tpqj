...
class EditAlmarufTransaction extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'tuition_month_ymd' => 'nullable|unique:almaruf_transactions,tuition_month,'.$this->id.',id,student_id,'.$this->student_id,
        ];
    }
