	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="help-block transaction_date" style="display:none"></div>
			</div>
			...
			<div class="form-group icheck">				
				...
				@endforeach
				<div class="help-block  transaction_type_id" style='display:none'></div>
			</div>	
			...
			<div class="form-group tuition_month_wrapper" style='display:none'>
				...
				<div class="help-block tuition_month" style="display:none"></div>
			</div>						
		...
		<div class="col-md-6">			
			...
			<div class="form-group icheck class_group_id_wrapper">				
				...
				@endforeach
				<div class="help-block  class_group_id" style='display:none'></div>
			</div>	
			...
			<div class="form-group">
				...
				<div class="help-block amount" style="display:none"></div>
			</div>
			<div class="form-group">
